...
class ReactionLvl3 : AppCompatActivity(), View.OnClickListener, Runnable {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bindingReactionLvl3.iBPauseScreen.setOnClickListener{goToPause()}
    ...
    private fun countdownTIme(){
        ...
        val probability : Double = flies * 2.0 / 60
    ...
    private fun levelPassed(){
        ...
        builder.setTitle(R.string.bt_lv3)
    ...
    private fun gameOverScreen(){
        ...
        builder.setNeutralButton("Try Again"){_, _ ->
            val intent = Intent(this, ReactionLvl3::class.java)
            startIntent(intent)
        }.show()
    }

    private fun writeIntoSharedPrefs(){
        val lvl = "lvl_3_checked"
