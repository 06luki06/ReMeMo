...
class Reaction_lvl2 : AppCompatActivity(), View.OnClickListener, Runnable {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        startGame()
        gameboard = bindingReaction_lvl2.FLGameboard
    ...
    private fun updateScreen(){
        val tV_flies_left : TextView = bindingReaction_lvl2.tVFlysLeft
        tV_flies_left.setText(flys_to_hit.toString())

        val tv_catched_flys : TextView = bindingReaction_lvl2.tVCatchedFlies
        tv_catched_flys.setText(catchedFlys.toString())

        val tVTimeLeft : TextView = bindingReaction_lvl2.tVTimeLeft
        tVTimeLeft.setText(time.toString())

        val flys_left_bar : FrameLayout = bindingReaction_lvl2.FLCatchedFlys
        val time_left_bar : FrameLayout = bindingReaction_lvl2.FLTimeLeft
        ...
        lpTime.width = Math.round(scale * time * 300 / 40)
    }
