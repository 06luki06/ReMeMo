...
class GameChoice : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bindingGames.iBHighscoreLink.setOnClickListener{contextHelper.startIntent(HighscoreGames::class.java, false, flag = false)}
        bindingGames.iBSettingsLink.setOnClickListener{contextHelper.startIntent(Settings::class.java, false, flag = false)}
        bindingGames.btGoToMemory.setOnClickListener{contextHelper.startIntent(MemoryGame::class.java, false, flag = false)}
        bindingGames.btGoToMotivity.setOnClickListener{dialogHelper.notYetImplemented("Go Back")}
        bindingGames.btGoToReaction.setOnClickListener{contextHelper.startIntent(ReactionGame::class.java, false, flag = false)}
    }
}