...
class Reaction_lvl5 : AppCompatActivity(), View.OnClickListener, Runnable {
    ...
    private val HIGHEST_AGE : Long = 200
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        startGame()
        gameboard = bindingReaction_lvl5.FLGameboard
    ...
    private fun updateScreen(){
        val tV_flies_left : TextView = bindingReaction_lvl5.tVFlysLeft
        tV_flies_left.setText(flys_to_hit.toString())

        val tv_catched_flys : TextView = bindingReaction_lvl5.tVCatchedFlies
        tv_catched_flys.setText(catchedFlys.toString())

        val tVTimeLeft : TextView = bindingReaction_lvl5.tVTimeLeft
        tVTimeLeft.setText(time.toString())

        val flys_left_bar : FrameLayout = bindingReaction_lvl5.FLCatchedFlys
        val time_left_bar : FrameLayout = bindingReaction_lvl5.FLTimeLeft
    ...
    private fun gameOverScreen(){
        ...
        builder.setNeutralButton("Try Again"){dialog, which ->
            val intent : Intent = Intent(this, Reaction_lvl5::class.java)
            startIntent(intent)
        }.show()
    }
